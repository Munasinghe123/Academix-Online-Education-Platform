...
function Cart() {
    ...
    return (
        <div className="mt-20 h-screen bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300 p-6">
            <div className="max-w-4xl mx-auto bg-white p-6 rounded-xl shadow-2xl">
                ...
                <div className="text-xl font-semibold text-gray-800 mb-6">
                    ...
                    <span className="text-orange-500">${paymentPrice.toFixed(2)}</span>
                </div>
                ...
                <div className="flex flex-wrap gap-8 justify-center">
                    {cartItems.length > 0 ? (
                        cartItems.map((info, index) => (
                            <div
                                key={index}
                                className="flex flex-col bg-white rounded-lg shadow-lg overflow-hidden w-64 p-4 space-y-4 hover:shadow-xl transition-shadow duration-300"
                            >
                                {/* Course Name */}
